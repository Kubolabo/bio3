...
public class YontakuMondai extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yontaku_mondai);
...
// 効果音を使えるように読み込み
    ...
    public void setQuestion() {
        ...
        sql = "SELECT Question, Ans0, Ans1, Ans2,Ans3,Ans4,Comment, Chap, Clear,Done,Fav FROM Select4 WHERE _id=" + QuestionNo;
        ...
        String Choice3 = c.getString(c.getColumnIndex("Ans3")); // 四択の選択肢3
        String Choice4 = c.getString(c.getColumnIndex("Ans4")); // 四択の選択肢4
        ...
        if (Chapter == Chap) {
            ...
            Intent intent = new Intent(YontakuMondai.this, Score.class);
    ...
    public void setQuestion2() {
        ...
        if(play<= 20) {
            ...
            Intent intent2 = new Intent(YontakuMondai.this, Score.class);
    ...
    public void onClick(View v) {
        ...
        if (((Button) v).getText().equals(Seikai)) {
            ...
            db.update("Select4", values, whereClause,new String[]{Qno});
            //データベース更新
        ...
        else if( v.getId()==(R.id.buttonF)) { //お気に入りが押されたとき
        ...
        else if( v.getId()==(R.id.buttonN)) { //次へが押されたとき
            tvKaisetu.setText("     ");
            switch (Menu) {
                case 1:
                    QuestionNo++;
            ...
            Toast toast = Toast.makeText(getApplicationContext(), "不正解! 正解は："+Seikai, Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER_VERTICAL | Gravity.CENTER_HORIZONTAL, 0, 0);
            toast.show();
            tvKaisetu.setText("解説： \n" + (Setumei));
            // データベースを更新処理
